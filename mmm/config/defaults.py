...
PRESETS = {
    "stealth-plus": {
        ...
        "verification": {"deep_analysis": True, "auto_verify": True},
        "performance": {"optimize_for_speed": True},
    },
    "stealth": {
        "paranoia_level": "maximum",
        "preserve_quality": "maximum",
        ...
        "spectral_cleaning": {"adaptive_noise": True, "smoothing_window": 3},
        "verification": {"deep_analysis": True, "auto_verify": True},
    },
    "fast": {
        "paranoia_level": "low",
        "preserve_quality": "medium",
        "watermark_detection": ["spread_spectrum", "statistical"],
        "spectral_cleaning": {"adaptive_noise": False},
        "verification": {"auto_verify": False, "deep_analysis": False},
        "performance": {"optimize_for_speed": True},
    },
    "quality": {
        "paranoia_level": "medium",
        "preserve_quality": "maximum",
        "metadata_cleaning": {"preserve_technical": True, "aggressive_mode": False},
        "quality_preservation": {
            "target_snr": 50,
            "max_quality_loss": 2,
            "preserve_dynamics": True,
...
PARANOIA_CONFIGS = {
    ...
    "medium": {
        "watermark_detection": ["spread_spectrum", "echo_based", "statistical"],
        "fingerprint_removal": {
            "statistical_normalization": True,
            "temporal_randomization": True,
            "phase_randomization": False,
        ...
        "spectral_cleaning": {"adaptive_noise": True},
        "verification": {"auto_verify": True, "deep_analysis": False},
    },
    "high": {
        "watermark_detection": [
            "spread_spectrum",
        ...
        "spectral_cleaning": {"adaptive_noise": True, "smoothing_window": 3},
        "verification": {"auto_verify": True, "deep_analysis": True},
    },
    "maximum": {
        "watermark_detection": [
            "spread_spectrum",
        ...
        "spectral_cleaning": {"adaptive_noise": True, "smoothing_window": 5},
        "metadata_cleaning": {"aggressive_mode": True, "strip_binary_chunks": True},
        "verification": {
            "auto_verify": True,
            "deep_analysis": True,
            "compare_spectra": True,
        },
        "advanced": {"include_experimental": True},
    },
}
