...
class MetadataCleaner:
            ...
            if not result["success"]:
                try:
                    ...
                    audio.export(
                        output_file,
                        format="wav",
                        parameters=["-write_id3v1", "0", "-write_id3v2", "0"],
                    )
    ...
    def clean_custom_chunks(
        self, file_data: bytes, allowed_chunks: List[bytes]
    ) -> bytes:
        """
